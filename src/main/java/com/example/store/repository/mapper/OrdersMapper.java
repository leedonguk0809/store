...
public interface OrdersMapper {
    ...
    void insertOrderItem(@Param("orderId") Long orderId, @Param("itemId") Long itemId, @Param("itemCount") Integer itemCount,@Param("price") Integer price , @Param("totalItemPrice") Integer totalItemPrice);
